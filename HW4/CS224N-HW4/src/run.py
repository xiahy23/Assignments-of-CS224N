...
if args.variant == 'vanilla':
    ...
    ### YOUR CODE HERE ###
    model = models.GPT(mconf).to(device) #Ensure the use of GPU
    ### END YOUR CODE ###
...
if args.function == 'pretrain':
    ...
    ### YOUR CODE HERE ###
    tconf_pretrain = trainer.TrainerConfig(
        max_epochs=650,
        batch_size=128,
        learning_rate=args.pretrain_lr,
        lr_decay=True,
    ...
    trainer_pretrain = trainer.Trainer(model, pretrain_dataset, None, tconf_pretrain)
    ...
    trainer_finetune = trainer.Trainer(model, finetune_dataset, None, trainer_config)
