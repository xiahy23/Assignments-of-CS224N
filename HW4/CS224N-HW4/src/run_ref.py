...
mconf = models.GPTConfig(pretrain_dataset.vocab_size, pretrain_dataset.block_size,
...
if args.variant == 'vanilla':
    ...
    model = models.GPT(mconf).to(device) #after you load the model, it is no longer on GPU so add .to(device)
